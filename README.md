...
Polls package registries and reports when tracked tools release new versions.
...
```bash
git clone https://github.com/asyncvd/updatechaser.git
cd updatechaser
```
